...
class BrandPage extends Component {
  ...
  filterProductsByCategory = (allProduct, targetCategory) => {
    return allProduct.filter((product, index) => allProduct[index].brandIdData.name === targetCategory);
  };
  render() {
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(BrandPage));
